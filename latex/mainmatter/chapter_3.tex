...
\input{mainmatter/chapter3/general_handling}

\input{mainmatter/chapter3/continuous_effect}

\input{mainmatter/chapter3/keyword}

\input{mainmatter/chapter3/zones}

\input{mainmatter/chapter3/state_based}